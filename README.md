...
2. **改成你的**：打开 `00_用户档案.md`，把里面的示例换成你自己的信息——你是谁、做什么工作、有什么习惯和规矩
3. **发给AI**：把 `04_接入指令模板.md` 里的内容复制，发给你用的任何AI（豆包/Kimi/DeepSeek/Claude/OpenAI都可以），它自己会读完所有规则，按你的习惯干活
...
这套系统里22条从真实踩坑长出来的协作机制，看这里：[07_机制亮点清单.md](./07_机制亮点清单.md)
...
├── 08_指挥中心模板.md             # 📺 用户仪表盘模板：当前重点/待办/待决策/项目速查，复制即用
