...
### 第二步：把知识库中的 `_入项指引.md` 发给你电脑上使用到的**所有** AI

发给**可以读写本地文件的 AI**（比如豆包、Kimi、WorkBuddy、OpenClaw 等）——复制文件内容发给它，或者直接把知识库文件夹路径复制给它，都一样。

**这样 AI 就会秒懂这个知识库。你不懂的，可以问 AI 了——包括"这个 skill 是什么？怎么用？"**
