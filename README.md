...
1. **文件夹放哪？** —— 和你的项目文件夹**平行**放。**项目泛指一切需要用 AI 辅助干活的事**：软件开发、教材课件、学习规划、数据分析、资料整理、写报告、做表格、查资料……**很多人不知道自己用得上 AI——记住：你日常任何需要查资料、写东西、算数据、整理信息的事，都可以让 AI 帮你干，那就算一个"项目"**。这样知识库才能同时管所有项目
